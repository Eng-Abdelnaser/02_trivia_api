...
`curl -X POST http://127.0.0.1:5000/questions -H "Content-Type: application/json" -d '{"question":"The number of continents of the world?", "answer":"7","difficulty":1,"category":3}'` 

{
  "question": {
    ...
    "difficulty": 1,
    "id": 24,
    "question": "The number of continents of the world?"
  },
  "success": true
}
