...
def create_app(test_config=None):
    ...
    def add_questions():
            ...
            if body.get('searchTerm') != None :
                return search(request,str(body.get('searchTerm')))
            for key in ['question', 'answer', 'difficulty', 'category'] :
                if  body.get(key)== None or body.get(key) == '' :
                    abort(406)
    ...
    def get_questions_by_category(category_id):
        try:
            ...
            current_questions = paginate_questions(request, questions)
            current_category[category_id]=category.type
    ...
    def quizzes():
        ...
        if quiz_category == 0 : 
            ...
            category_id =str(quiz_category.get('id'))
